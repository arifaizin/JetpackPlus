...
//            modelClass.isAssignableFrom(com.arifaizin.jetpackpro.favorite.viewmodel.FavoriteViewModel::class.java) -> com.arifaizin.jetpackpro.favorite.viewmodel.FavoriteViewModel( movieRepository ) as T
