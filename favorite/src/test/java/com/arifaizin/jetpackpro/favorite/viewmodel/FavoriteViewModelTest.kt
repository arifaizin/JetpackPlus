...
class FavoriteViewModelTest {
    ...
    private val favoriteInteractor = mock(FavoriteInteractor::class.java)
    ...
    fun getDataMovie() {
        ...
        `when`(favoriteInteractor.getFavoriteMovies()).thenReturn(dummyMovies)
    ...
    fun getDataTvShow() {
        ...
        `when`(favoriteInteractor.getFavoriteTvShow()).thenReturn(dummyTvShow)
